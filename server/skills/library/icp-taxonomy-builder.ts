 ...
 * - Phase 2 (CLASSIFY): ~6.9K tokens - DeepSeek classifies top 50 accounts
 * - Phase 3 (SYNTHESIZE): ~4.5K tokens - Claude builds taxonomy report
 *
 * Scheduling:
...
export const icpTaxonomyBuilderSkill: SkillDefinition = {
  ...
  requiredTools: ['buildICPTaxonomy', 'enrichTopAccounts', 'classifyAccountPatterns', 'persistTaxonomy'],
  requiredContext: [],
