...
router.get('/:workspaceId/admin/scopes', requirePermission('config.view'), async (req: Request, res: Response): Promise<void> => {
...
router.get('/:workspaceId/admin/scopes/:scopeId/preview', requirePermission('config.view'), async (req: Request, res: Response): Promise<void> => {
  const workspaceId = req.params.workspaceId as string;
