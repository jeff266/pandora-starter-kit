      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <svg width="16" height="11" viewBox="0 0 48 32" fill="none">
            <path d="M24 4C14 4 6 12 2 16c4 4 12 12 22 12s18-8 22-12C42 12 34 4 24 4z" stroke={t.textMuted} strokeWidth="2" fill="none" />
            <circle cx="24" cy="16" r="3" fill={t.textMuted} />
          </svg>
          <span style={{ fontSize: 12, color: t.textMuted }}>pandora · revops intelligence</span>
        </div>
