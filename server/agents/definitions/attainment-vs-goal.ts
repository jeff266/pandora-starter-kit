...
Keep it under 500 words. This is the executive check-in.`,
  ...
  goal: 'Give leadership a definitive, data-grounded answer to "will we hit the number?" every time this runs — with the specific deals and actions that determine the outcome.',
  standing_questions: [
    'What is the current attainment percentage and the dollar gap to quota?',
    'Which reps are behind their individual quota, and by how much?',
    'What is the pipeline coverage ratio, and is it sufficient to close the gap?',
    'Which deals in the forecast are most critical to hitting the number, and what is their risk status?',
    'At current run rate and win rate, do we hit quota by end of period?',
  ],
