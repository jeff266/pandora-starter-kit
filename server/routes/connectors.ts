...
router.delete('/:workspaceId/connectors/:connectorType', requirePermission('config.edit'), async (req: Request<{ workspaceId: string; connectorType: string }>, res: Response) => {
  try {
    const { workspaceId, connectorType } = req.params;
